        ...
        for detection in msg.detections:
            ...
            if self.object_classes[class_id] == "bottle":
                ...
                Tscr_ob = np.array([[1, 0, 0, result.pose.pose.position.x],
                                     ...
                                     [0, 0, 1, 0],
                                     [0,0,0,1]])
                Ttor_ob = Ttor_cam@Tcam_scr @ Tscr_ob

                obj.object_name = f"{self.object_classes[class_id]}"
                obj.pose_stamped.pose.position.x = Ttor_ob[0][3]
                obj.pose_stamped.pose.position.y = Ttor_ob[1][3]
                obj.pose_stamped.pose.position.z = Ttor_ob[2][3]
                obj.pose_stamped.pose.orientation.w = 1.0
                obj.pose_stamped.pose.orientation.x = 0.0
                obj.pose_stamped.pose.orientation.y = 0.0
                obj.pose_stamped.pose.orientation.z = 0.0
                msg_array.data.append(obj)
                print(f"Tcam_ob: {Ttor_ob}") 
